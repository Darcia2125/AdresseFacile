...
const AdresseClassScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formSection}>
        <View style={styles.messageContainer}>
          <Text style={styles.messageText}>
            <Text style={styles.boldLargeText}>Classez{"\n"}Votre adresse</Text>
          </Text>
        </View>
      ...
      <View style={styles.cameraContainer}>
        ...
        <Text onPress={() => navigation.navigate('Individual')}
          style={[
            styles.cameraText,
            {
...
export default AdresseClassScreen;
