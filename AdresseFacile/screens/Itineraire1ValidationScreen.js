    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formSection}>
          <View style={styles.messageContainer}>
            <Text style={styles.messageText}>
              <Text style={styles.boldLargeText}>Valider les adresses de{"\n"}votre itinéraire 
              </Text>
            </Text>
          </View>
          </View>
          ...
          <TouchableOpacity style={styles.iconButton}>
            ...
            placeholder="Départ"
            value={locations.depart}
            onChangeText={(value) => handleChange('depart', value)}
            />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.iconButton}>
            ...
            value={locations.repere1}
            onChangeText={(value) => handleChange('repere1', value)}
            />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.iconButton}>
            ...
            value={locations.repere2}
            onChangeText={(value) => handleChange('repere2', value)}
            />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.iconButton}>
            ...
            style={styles.textInput}
            placeholder="Arrivée"
            value={locations.arrivee}
            onChangeText={(value) => handleChange('arrivee', value)}
            />
        </TouchableOpacity>
          </View>
        ...
        {/* Bouton Lancer */}
        <TouchableOpacity style={styles.launchButton} onPress={() => navigation.navigate('ItineraireCar')}>
          <Text style={styles.launchText}>Valider</Text>
        </TouchableOpacity>
      </ScrollView>
